...
![Pre-built Agent](./images/ch02/00-prebuilt-agent.png)
...
![Copilot Studio Login](./images/ch02/01-copilotstudio-login.png)
...
![Select Template](./images/ch02/02-select-template.png)
...
![Create Agent](./images/ch02/03-create-agent.png)
...
![Agent Settings](./images/ch02/04-agent-settings.png)

에이전트 생성 후,  
오른쪽 상단의 **설정** 메뉴를 선택합니다.

![Orchestration](./images/ch02/05-orchestration.png)
...
![Add Knowledge](./images/ch02/06-add-knowledge.png)
...
![Test Agent](./images/ch02/07-test-agent.png)
...
![Publish Agent](./images/ch02/08-publish-agent.png)
